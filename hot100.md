...
1.动态规划法
    ...
    附参考链接：https://leetcode.cn/problems/maximum-subarray/solution/dong-tai-gui-hua-fen-zhi-fa-python-dai-ma-java-dai/
...
var maxDepth = function (root) {
    if (!root) {
        ...
        // 这个是递归回退的时候计算的值，递归到最后一层时 left/right=0，+1后最大的就是1
        // 然后一层一层回退回去得到深度
