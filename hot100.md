...
- [[数组] 33.搜索旋转排序数组 TODO](#数组-33搜索旋转排序数组-todo)
- [[数组] 34.在排序数组中查找元素的第一个和最后一个位置 TODO](#数组-34在排序数组中查找元素的第一个和最后一个位置-todo)
- [[数组] 39.组合总和 TODO](#数组-39组合总和-todo)
 ...
 * 代码实现就参照代表实现思路按点看就行
 * 
 *  1. 找小数和找大数的遍历代码实现只要一根指针就够，好好看一下
 *     一开始自己写的实现复杂了
 *  2. 注意边界问题，主要是值相等的情况
 * 
 *  时间复杂度 O(n)
...
### [数组] 34.在排序数组中查找元素的第一个和最后一个位置 TODO
